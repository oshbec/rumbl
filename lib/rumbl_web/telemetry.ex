defmodule RumblWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      summary("rumbl.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("rumbl.repo.query.idle_time", unit: {:native, :millisecond}),
